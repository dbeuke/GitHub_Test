...
To use these stylesheets, rename the files and omagedesktop with the name of your theme.
...
omagedesktop-alpha-default.css
...
omagedesktop-alpha-default-narrow.css  
...
omagedesktop-alpha-default-normal.css
...
omagedesktop-alpha-default-wide.css
